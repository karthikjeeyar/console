...
type DefaultRemoveConnectorWidgetProps = {
  startPoint: Point;
  endPoint: Point;
  onRemove(): void;
  size?: number;
...
const DefaultRemoveConnectorWidget: React.FC<DefaultRemoveConnectorWidgetProps> = ({
  startPoint,
  endPoint,
  onRemove,
  size = 14,
...
export default DefaultRemoveConnectorWidget;
